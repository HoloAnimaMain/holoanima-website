...
export default async function VideosPage() {
  const videos: Video[] = await getYouTubeVideos('es', 12);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="prose max-w-none">
          ...
          <section className="mb-12 text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Nuestros Videos</h1>
            <p className="text-lg text-muted max-w-2xl mx-auto">
              Explora nuestra colección de videos educativos con animación AI diseñados para inspirar y entretener a las mentes jóvenes.
            </p>
          </section>
          ...
          {videos.length > 0 ? (
            ...
            <section className="text-center py-12">
              <div className="bg-gradient-to-br from-red-100 to-pink-100 rounded-lg p-8 max-w-2xl mx-auto">
                ...
                <h3 className="text-2xl font-bold text-foreground mb-2">Próximamente Videos</h3>
                <p className="text-muted mb-6">
                  Estamos trabajando en contenido educativo increíble. ¡Vuelve pronto para ver nuestros últimos videos!
                </p>
                <a
          ...
          <section className="bg-gradient-to-r from-primary to-primary-dark text-white py-12 rounded-2xl mt-12 text-center">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold mb-4">No Te Pierdas Ningún Video</h2>
              <p className="text-xl mb-6 max-w-2xl mx-auto">
                Suscríbete a nuestro canal de YouTube y sé el primero en ver nuestro nuevo contenido educativo.
              </p>
              <a
                href="https://youtube.com/@holoanima?sub_confirmation=1"
                target="_blank"
